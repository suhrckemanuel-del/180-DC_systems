...
Research and planning done (2026-07-08). Waiting on: President's answers to the [open questions](01-brainstorm.md#11-open-questions-for-the-president), and [access items](02-build-stack.md#access-list--in-priority-order) from Manuel. Variant building can start before either — gallery research, design briefs and CSS/SVG variants need no access.
