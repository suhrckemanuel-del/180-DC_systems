...
Every idea, flat. The visual relationships live in [idea-map.md](idea-map.md). Stages: spark, shaping, ready, building, shipped, parked.

| Idea | Stage | Owner | Card | Note |
|---|---|---|---|---|
...
Add a row when you add a card. Move the stage as the thinking moves. Keep the note to one line. If a row has no card yet, that is fine: a backlog row is a placeholder for a card that does not exist yet.
